...
$(document).ready(function(){
    ...
    function add() {
        ...
        var new_input = "<input type='text' class='mb-1' id='new_" + new_chq_no + "' />";
    ...
    function addCollection() {
        ...
        var new_col = "<div class='col-sm-6  col-md-3' id='new_" + new_col_no + "' ><div class='browse-card' id='total_col'><div class='imgbox'><i class='fas fa-folder-open'></i></div><div class='browse-card-content no-padding'><textarea class='filename' cols='30' rows='3' disabled>Type Collection name here. Edit to change the Collection name.</textarea><p class='text-right text-secondary options'><a href='research.html'><i class='fas fa-eye'></i></a><a href='editresearch.html' class='btnEditCollection'><i class='fas fa-edit'></i></a><a href='#' class='btnDeleteResearch'><i class='fas fa-minus-circle remove-collection'></i></a></p></div></div></div> ";
